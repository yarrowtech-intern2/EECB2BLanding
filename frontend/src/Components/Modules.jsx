...
export default function EECModules() {
  ...
  return (
    <section id="modules" className="relative overflow-hidden bg-white">
      ...
      {/* WHITE SECTION + CARDS */}
      {/* ===================== */}
      <div id="modules" className="relative py-14 sm:py-16 lg:py-20 overflow-hidden">
        {/* Soft background */}
                ...
                className={`px-6 py-2.5 rounded-full text-sm font-bold border transition-all duration-300
                  ${
                    activeModule === item.key
                      ? "bg-yellow-400 text-black border-yellow-400 shadow-md cursor-pointer"
                      : "bg-white text-slate-800 border-slate-200 hover:border-yellow-400 hover:bg-yellow-50 cursor-pointer"
                  }`}
              >
                {item.label}
              </button>
              ...
              return (
                ...
                >
                  <div className="
                    ...
                    group-hover:-translate-y-2 group-hover:shadow-[0_22px_55px_rgba(15,23,42,0.16)]
                    transform-gpu
                  ">
                    {/* LEFT DIAGONAL STRIP */}
